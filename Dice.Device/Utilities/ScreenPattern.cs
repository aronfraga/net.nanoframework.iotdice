namespace Dice.Device.Utilities
{
    internal class ScreenPattern
    {
        ...
        private readonly short[] ThrowAnimation  = { 2, 2, 5, 5,
                                                     0, 0, 4, 4, 5, 5,
                                                     0, 0, 2, 2, 4, 4, 5, 5,
                                                     0, 0, 0, 4, 4, 0, 4, 4, 5, 5,
                                                     0, 0, 0, 4, 2, 2, 4, 0, 4, 4, 5, 5,
                                                     0, 0, 0, 4, 0, 2, 4, 2, 4, 0, 4, 4, 5, 5 };

        private readonly short[] LoadAnimation   = { 1, 1, 1, 2, 1, 3, 2, 1, 2, 3, 3, 1, 3, 3, 5, 5,
                                                     1, 1, 1, 2, 1, 3, 2, 1, 2, 3, 3, 1, 3, 2, 5, 5,
                                                     1, 1, 1, 2, 1, 3, 2, 1, 3, 1, 3, 2, 3, 3, 5, 5,
                                                     1, 1, 1, 2, 2, 1, 2, 3, 3, 1, 3, 2, 3, 3, 5, 5,
                                                     1, 1, 1, 3, 2, 1, 2, 3, 3, 1, 3, 2, 3, 3, 5, 5,
                                                     1, 2, 1, 3, 2, 1, 2, 3, 3, 1, 3, 2, 3, 3, 5, 5,
                                                     1, 1, 1, 2, 1, 3, 2, 3, 3, 1, 3, 2, 3, 3, 5, 5,
